...
const mockResults = [
  ...
  {
    number: "2234567890",
    basic: { first_name: "John", last_name: "Smith", organization_name: "John Smith MD" },
    addresses: [
  ...
  {
    number: "4234567890",
    basic: { first_name: "Micah", last_name: "Edwin", organization_name: "Micah Edwin MD Practice" },
    addresses: [
  ...
  },
  {
    ...
    addresses: [
      { address_purpose: "LOCATION", city: "Orlando", state: "FL" }
    ]
  }
];
...
console.log(`Running NPI verify search benchmarks with ${iterations} iterations...`);
