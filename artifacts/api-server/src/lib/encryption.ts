 ...
 */
/**
 * Optimized internal helper that takes a pre-decoded payload Buffer and resolved key.
 */
function tryDecryptWithAADBuffer(
  combined: Buffer,
  key: Buffer,
...
export function decrypt(
  ...
  for (const aad of candidates) {
    const result = tryDecryptWithAADBuffer(combined, key, aad);
