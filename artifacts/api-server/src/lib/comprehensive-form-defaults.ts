...
export const COMPREHENSIVE_FORM_DEFAULTS: Map<string, WebFormConfig> = new Map(FORMS);

export function getComprehensiveDefault(tortId: string): WebFormConfig | undefined {
  return COMPREHENSIVE_FORM_DEFAULTS.get(tortId);
}
