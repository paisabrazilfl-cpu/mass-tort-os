...
function buildSystemPrompt(tort: TortDefinition, questions: string[]): string {
  ...
  return [
    ...
    "Speech: plain language, natural contractions (I'm, we'll, that's). Slow down and enunciate on dates, name spellings, and condition names. Soft acknowledgments (\"I'm sorry you went through that\", \"take your time\"). One question at a time — never stack questions.",
