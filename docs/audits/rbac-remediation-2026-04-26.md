...
Boot-time count: **258 checked / 42 public / 216 protected / 0 unprotected.**

The table below is generated automatically from the live express tree. Do NOT
edit it by hand. Regenerate it by following the instructions in Section 1.
...
| automations | GET | `/api/automations/debug/tables` | ✓ | ✓ |  |  |  | — | `automations:manage` | ✓ |
...
| health | GET | `/api/health/admin/ci-status` |  |  | ✓ |  |  | — | — | — |
...
| webhooks | POST | `/api/webhooks/automation-trigger/:slugOrId` |  |  | ✓ |  |  | — | — | — |
...
[16:19:44.873] [32mINFO[39m (630111): [36mRoute policy report[39m
    [35mchecked[39m: 258
    [35mpublic[39m: 42
    [35mprotected[39m: 216
    [35mby_status[39m: {
      "public": 37,
      "auth-exception": 5,
      "auth-only": 10,
    ...
    [35mpolicy[39m: [
      ...
      },
      {
        "router": "webhooks",
        "method": "POST",
        "path": "/vapi/intake-result",
        "status": "public"
      },
      {
        "router": "webhooks",
        "method": "POST",
        "path": "/vapi/escalate-human",
        "status": "public"
      },
      {
        "router": "webhooks",
      ...
      },
      {
        "router": "webhooks",
        "method": "POST",
        "path": "/automation-trigger/:slugOrId",
        "status": "public"
      },
      {
        "router": "vapi-tools",
      ...
      },
      {
        "router": "analytics",
        "method": "GET",
        "path": "/predictive/lead/:id",
        "status": "role-gated",
        "requiredPermissions": [
          "analytics:predictive:lead"
        ]
      },
      {
        "router": "analytics",
        "method": "GET",
        "path": "/predictive/batch",
        "status": "role-gated",
        "requiredPermissions": [
          "analytics:view"
        ]
      ...
      },
      {
        ...
        "status": "role-gated",
        "requiredPermissions": [
          "forms:background_check"
        ]
      },
      {
        "router": "forms",
        "method": "POST",
        "path": "/background-check/lead/:id",
        "status": "role-gated",
        "requiredPermissions": [
          "forms:background_check"
        ]
      },
      {
        "router": "forms",
        "method": "POST",
        "path": "/background-check-hub/lead/:id",
        "status": "role-gated",
        "requiredPermissions": [
          "forms:background_check"
        ]
      },
      {
        "router": "forms",
        "method": "GET",
        "path": "/background-check-hub/lead/:id/snapshots",
        "status": "role-gated",
        "requiredPermissions": [
          "forms:background_check"
        ]
      ...
      },
      {
        ...
        "status": "role-gated",
        "requiredPermissions": [
          "decision_engine:manage"
        ]
      },
      {
        "router": "decision-engine",
        "method": "POST",
        "path": "/leads/:id/recompute",
        "status": "role-gated",
        "requiredPermissions": [
          "decision_engine:manage"
        ]
      ...
      },
      {
        "router": "document-templates",
        "method": "GET",
        "path": "/assignments/by-template/:templateId",
        "status": "role-gated",
        "requiredPermissions": [
          "templates:view"
        ]
      ...
      {
        "router": "workflow-settings",
        "method": "GET",
        "path": "/",
        "status": "role-gated",
        "requiredPermissions": [
          "workflow_settings:view"
        ]
      },
      {
        "router": "workflow-settings",
      ...
      },
      {
        ...
        "status": "role-gated",
        "requiredPermissions": [
          "workflow_settings:manage"
        ]
      },
      {
        "router": "workflow-settings",
        "method": "GET",
        "path": "/_options/providers",
        "status": "role-gated",
        "requiredPermissions": [
          "workflow_settings:manage"
        ]
      ...
      {
        "router": "admin-competitive-intel",
        "method": "GET",
        "path": "/config",
        "status": "role-gated",
        "requiredPermissions": [
