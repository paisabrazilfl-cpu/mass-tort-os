...
export const workflowSettingsTable = pgTable("workflow_settings", {
  ...
  sms_provider_integration_id: integer("sms_provider_integration_id"),
  voice_provider_integration_id: integer("voice_provider_integration_id"),
  llm_default_provider_integration_id: integer("llm_default_provider_integration_id"),
  llm_drafting_provider_integration_id: integer("llm_drafting_provider_integration_id"),
